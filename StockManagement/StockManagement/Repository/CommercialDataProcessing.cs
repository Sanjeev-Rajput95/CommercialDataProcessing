...
namespace StockManagement.Repository
{
    ...
    {
        public static string CustomerInfoFilePath = @"C:\Bridgelabz\Commercial data processing\CommercialDataProcessing\StockManagement\StockManagement\JSON\CustomeerInfo.json";
        public static string JsonFilePath = @"C:\Bridgelabz\Commercial data processing\CommercialDataProcessing\StockManagement\StockManagement\JSON\StocksData.json";
